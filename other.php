...
<head>
    <meta charset="utf-8">
    <title><?php echo $aCName; ?> - Other Categories</title>
...
<?php
            ...
            if(mysqli_num_rows($getAllPageArticlesResultsOriginal) > 0)
            {
                echo '        <p>There are ' . mysqli_num_rows($getAllPageArticlesResultsOriginal) . ' articles (5 articles per page).</p>';
            }
            ...
            if(!($getAllPageArticlesRow = mysqli_fetch_array($getAllPageArticlesResults)))
            {
