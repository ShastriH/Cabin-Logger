...
<head>
    <meta charset="utf-8">
    <title><?php echo $aCName; ?> - Web Development</title>
    <?php require_once("includes/head.php"); ?>
</head>
<body>
    <?php require_once("includes/header.php"); ?>
    <main>
        <section id="webDevelopmentArticles">
...
<?php
            ...
            echo '        <p>There are ' . mysqli_num_rows($getAllPageArticlesResultsOriginal) . ' Web Development articles (5 articles per page).</p>';
