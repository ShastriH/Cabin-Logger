...
<head>
    <meta charset="utf-8">
    <title><?php echo $aCName; ?> - Digital Media</title>
    <?php require_once("includes/head.php"); ?>
</head>
<body>
    <?php require_once("includes/header.php"); ?>
    <main>
        <section id="digitalMediaArticles">
        <h1>Digital Media Articles</h1>
        <?php
            $categoryID = 2;
            // Acquire the original articles under the page's category
            ...
            echo '        <p>There are ' . mysqli_num_rows($getAllPageArticlesResultsOriginal) . ' Digital Media articles (5 articles per page).</p>';
            ...
            if($i > 1) {
                ...
                while($i > 0) {
                    ...
                    if($j === (($skip + $limit) / $limit)) {
                        ...
                        echo '" title="Go to page ' . $j . '"><li>' . $j. '</li></a>' . "\n";
                    }
                    $i--;
                    $j++;
